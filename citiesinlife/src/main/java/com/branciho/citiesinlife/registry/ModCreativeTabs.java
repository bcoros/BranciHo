    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN = TABS.register("main",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModItems.SEALING_BLOCK.get());
                        output.accept(ModItems.URANIUM_STORAGE.get());
                        output.accept(ModItems.NUCLEAR_TURBINE.get());
                        output.accept(ModItems.INPUT_WATER_PORT.get());
                        output.accept(ModItems.OUTPUT_COOLED_PORT.get());
                        output.accept(ModItems.INPUT_COOLED_PORT.get());
                        output.accept(ModItems.OUTPUT_HEATED_PORT.get());
                        output.accept(ModItems.STEAM_EMITTER.get());
                        output.accept(ModItems.PRESSURIZED_PIPE.get());
                        output.accept(ModItems.COOLER_LEVER.get());
                        output.accept(ModItems.HEAT_LEVER.get());
                        output.accept(ModItems.PRESSURE_LEVER.get());
                        output.accept(ModItems.TURBINE_POWER.get());
                        output.accept(ModItems.MAIN_MONITOR.get());
